            ...
            <div class="input-group input-group-sm mb-3">
              ...
              <select class="form-select" id="inputGroupSelect01">
                <option selected>Choose services availbale.....</option>
                  ...
                  <option value="4">Hair styling</option>
              </select>
            </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
      <div class="modal-content">
        ...
        <form class="form" action="Process/ramilProcess.php" method="post" id="ramilForm" >
          <h1 class="display-3"><i class="fa-solid fa-user"></i> Ramill</h1>
            <p class="lead">Please fill in the details to book an appointment with Barber Ramill:</p>
            <div class="input-group input-group-sm mb-3">
              <span class="input-group-text" id="inputGroup-sizing-sm">Check-in Date</span>
              <input type="date" id="check-in-Date" name="dateIn" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" required>
            </div>
